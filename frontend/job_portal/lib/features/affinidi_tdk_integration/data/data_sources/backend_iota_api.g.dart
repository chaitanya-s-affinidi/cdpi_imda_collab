...
class _BackendIotaApi implements BackendIotaApi {
  ...
  Future<IotaVCVerificationOutput> verifyVCs(
      IotaVCVerificationInput input) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = input;
    final _options = _setStreamType<IotaVCVerificationOutput>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late IotaVCVerificationOutput _value;
    try {
      _value = IotaVCVerificationOutput.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
